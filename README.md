...
| 🎨 **Три стиля баннера** | Градиент по акцентному цвету (берётся из иконки через Palette), тёмный минимализм, только иконка |
...
| Сетка приложений | Панель деталей | Сгенерированный баннер |
|---|---|---|
| ![Сетка](docs/screenshots/screen1.png) | ![Детали](docs/screenshots/screen2.png) | ![Баннер](docs/screenshots/screen3.png) |
...
- ☕ [Boosty](https://boosty.to/YOUR_NAME) — разовый донат или подписка
- 💳 [ЮMoney](https://yoomoney.ru/to/YOUR_WALLET_ID) — карта или кошелёк
